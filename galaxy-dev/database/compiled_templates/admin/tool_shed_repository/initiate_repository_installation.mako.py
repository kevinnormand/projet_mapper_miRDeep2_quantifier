...
_magic_number = 10
_modified_time = 1466780474.174463
_enable_loop = True
...
def _mako_generate_namespaces(context):
    ns = runtime.TemplateNamespace('__anon_0x7ff4dc1d60d0', context._clean_inheritance_tokens(), templateuri=u'/admin/tool_shed_repository/common.mako', callables=None,  calling_uri=_template_uri)
    context.namespaces[(__name__, '__anon_0x7ff4dc1d60d0')] = ns
...
def render_body(context,**pageargs):
    ...
    try:
        ...
        _import_ns = {}
        _mako_get_namespace(context, '__anon_0x7ff4dc1d60d0')._populate(_import_ns, [u'*'])
