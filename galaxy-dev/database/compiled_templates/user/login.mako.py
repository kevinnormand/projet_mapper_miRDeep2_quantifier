...
_magic_number = 10
_modified_time = 1466779619.869872
_enable_loop = True
...
def _mako_generate_namespaces(context):
    ns = runtime.TemplateNamespace('__anon_0x7f8dec130a10', context._clean_inheritance_tokens(), templateuri=u'/message.mako', callables=None,  calling_uri=_template_uri)
    context.namespaces[(__name__, '__anon_0x7f8dec130a10')] = ns
...
def render_body(context,**pageargs):
    ...
    try:
        ...
        _import_ns = {}
        _mako_get_namespace(context, '__anon_0x7f8dec130a10')._populate(_import_ns, [u'render_msg'])
